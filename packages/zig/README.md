...
<!-- alef:hash:7ee5b30ba032384b0dd82185a3a776d43735e793a45128c42ba910ff3dbce8ad -->
...
```bash
zig fetch --save https://github.com/xberg-io/html-to-markdown/releases/download/v3.12.2/zig.tar.gz
```
