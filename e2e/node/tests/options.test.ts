...
// alef:hash:20db94d488a29e73461924fd72bcc769afdd4ab44486d6ab6ddf697dbbdde2fd
...
describe("options", () => {
	...
	it("options_br_in_tables_nested_table_rows: A nested table flattened into a cell keeps its row boundaries as literal <br> when br_in_tables is enabled", () => {
		const result = convert("<table><tr><td><p>Before</p><table><tr><th>ID</th><th>Status</th></tr><tr><td>123</td><td>Done</td></tr></table></td></tr></table>", { brInTables: true, compactTables: true } as ConversionOptions);
	...
	it("options_custom_bullets_apply_to_layout_table_rows: A layout table renders its rows as list items, and those markers honour the bullets option like any other list", () => {
		const result = convert("<table><tr><td>alpha</td><td>beta</td></tr><tr><td>a</td><td>b</td><td>c</td></tr></table>", { bullets: "*+-" } as ConversionOptions);
