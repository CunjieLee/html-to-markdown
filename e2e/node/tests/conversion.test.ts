...
// alef:hash:7e829d5625fdebf7595ec0ff4e7e9f2c75f2979e00233bc0d092cce896a066f7
...
describe("conversion", () => {
	...
	it("table_layout_cell_paragraphs_stay_separated: Adjacent paragraphs in a layout-table cell are separated rather than concatenated into one run of text", () => {
		const result = convert("<table><tr><td><p><b>Alice Example</b></p><p><i>Customer Service</i></p></td><td>Logo</td></tr><tr><td>A</td><td>B</td><td>C</td></tr></table>", { compactTables: true } as ConversionOptions);
