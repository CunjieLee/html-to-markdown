 ...
 * alef:hash:3ea4a8a62bc427d456085486211e33a19f7f0a7ae57d157915a49ca45f0461fe
...
void test_table_layout_cell_paragraphs_stay_separated(void) {
    ...
    assert(result != 0 && "expected call to succeed");
    char* content = htm_conversion_result_content(result);
    assert(content != NULL && strstr(content, "**Alice Example***Customer Service*") == NULL && "expected non-null value without substring");
    assert(content != NULL && strstr(content, "Alice Example") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "Customer Service") != NULL && "expected to contain substring");
    assert(content != NULL && strstr(content, "Logo") != NULL && "expected to contain substring");
    htm_free_string(content);
    htm_conversion_options_free(options_handle);
    htm_conversion_result_free(result);
}
