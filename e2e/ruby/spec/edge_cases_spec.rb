...
# alef:hash:cbdeb612461c8fdd8f32e727e38bad296f9a864ac6e1ed9f9be288d148697af3
...
RSpec.describe 'edge-cases' do
  ...
  it 'hidden_content_font_size_zero_dropped: Elements hidden via inline style="font-size:0" render nothing and must not appear in the output' do
  ...
  it 'hidden_content_font_size_zero_with_reset_child_kept: font-size:0 is also an inline-block spacing hack: a descendant restoring a non-zero size does render, so its text is kept' do
  ...
  it 'malformed_uppercase_void_tag_keeps_following_content: HTML tag names are case-insensitive: an uppercase void element must not swallow the content that follows it' do
