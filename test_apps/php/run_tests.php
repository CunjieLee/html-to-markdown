...
// alef:hash:0c126db77b05287d6ddcbec8883624fe7dd134c5bcb5c5f90bfa362fb3249526
...
$localExtPath = __DIR__ . '/../../target/release/libhtml_to_markdown_php' . $extSuffix;
...
if ($loadedVersion !== '>=3.12.1') {
    ...
    fwrite(STDERR, "  expected version: >=3.12.1\n");
